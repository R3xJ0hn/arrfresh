		...
		<div class="breadcrumb-inner">
			<ul class="list-inline list-unstyled">
                ...
                @if(!empty($product_cat_name))
                    <li class="active"> <a href="#">{{$product_cat_name}}</a></li>
                @endif

                
                {{-- @if(!empty($product_subcat_name))
                    <li class="active"><a href="#">{{$product_subcat_name}}</a></li>
                    <li class="{{!empty($product_cat_name) ? '' : 'active'}}"> <a href="#">{{$product_cat_name}}</a></li>
                @endif --}}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="price-box">
                                                ...
                                                $currentamount = $product->product_selling_price - $discount;
                                                @endphp
                                                ...
                                                @else
                                                    ...
                                                    <h4 style="text-indent: 1rem;">-{{round((($product->product_discount_price)/$product->product_selling_price) * 100)}}%</h4>
                                                @endif
                                            </div>
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div style="margin-top: 3%; display: {{$product->product_color != null ? 'none' : ''}};">
